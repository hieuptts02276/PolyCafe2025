...
public class DrinkJDialog extends javax.swing.JDialog implements DrinkController{
    ...
    private void tblDrinksMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblDrinksMouseClicked
        ...
        this.addDrinkToBill(); // Thêm đồ uống vào hóa đơn
        poly.cafe.util.XNofication.showSystemTraySuccess(
            "Thêm đồ uống", 
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        this.open(); // Tải dữ liệu ban đầu khi form mở
    poly.cafe.util.XNofication.showSystemTraySuccess(
        "Khởi động", 
        "Giao diện gọi món đã sẵn sàng."
    );
    }//GEN-LAST:event_formWindowOpened

    private void tblCategoriesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblCategoriesMouseClicked
        this.fillDrinks(); // Hiển thị danh sách đồ uống theo danh mục đã chọn
    poly.cafe.util.XNofication.showSystemTraySuccess(
        "Chọn danh mục", 
        "Đã hiển thị các món trong danh mục vừa chọn."
    );
...
public void setBill(Bill bill) {
    this.bill = bill; // Giả sử bạn có field `Bill bill`
}
}