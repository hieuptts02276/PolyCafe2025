...
public class ChangePasswordJDialog extends javax.swing.JDialog implements ChangePasswordController{
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        // Gọi phương thức lưu thực tế
    this.save();

    // Gửi thông báo cho người dùng
    XNofication.showSuccess(this, "Dữ liệu đã được lưu thành công.");
    XNofication.showSystemTraySuccess("Lưu dữ liệu", "Dữ liệu đã được ghi nhận.");
    }//GEN-LAST:event_btnSaveActionPerformed

    private void btnCloseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCloseActionPerformed
        // Gửi cảnh báo xác nhận trước khi đóng
    boolean confirm = XNofication.confirm(this, "Bạn có chắc muốn đóng cửa sổ này không?");
    if (confirm) {
        this.close(); // Đóng cửa sổ
        XNofication.showSystemTrayWarning("Đóng cửa sổ", "Bạn vừa đóng một cửa sổ làm việc.");
    } else {
        XNofication.showMessage(this, "Đã hủy thao tác đóng.", "Thông báo");
    }
    }//GEN-LAST:event_btnCloseActionPerformed

    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        this.open(); // Mở form với dữ liệu thực tế

    // Thông báo hệ thống và popup xác nhận
    XNofication.showSuccess(this, "Cửa sổ đã mở sẵn sàng.");
    XNofication.showSystemTraySuccess("Khởi động cửa sổ", "Dữ liệu đã được nạp khi mở cửa sổ.");
