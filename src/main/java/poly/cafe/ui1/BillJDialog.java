...
public class BillJDialog extends javax.swing.JDialog implements BillController {
    ...
    XNofication.showSuccess(this, "Mở giao diện chọn món thành công.");
    XNofication.showSystemTraySuccess("Thêm món", "Đang thêm món vào hóa đơn.");
    }//GEN-LAST:event_btnAddActionPerformed

    private void btnRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveActionPerformed
        int row = tblBillDetails.getSelectedRow();
    if (row == -1) {
        XNofication.showWarning(this, "Vui lòng chọn món cần xóa.");
        XNofication.showSystemTrayWarning("Xóa món", "Chưa chọn món để xóa.");
        return;
    }

    boolean confirm = XNofication.confirm(this, "Bạn có chắc muốn xóa món đã chọn không?");
    if (confirm) {
        this.removeDrinks();
        XNofication.showSuccess(this, "Đã xóa món khỏi hóa đơn.");
        XNofication.showSystemTraySuccess("Xóa món", "Món đã được xóa thành công.");
    } else {
        XNofication.showMessage(this, "Hủy thao tác xóa món.", "Thông báo");
    }
    }//GEN-LAST:event_btnRemoveActionPerformed

    private void btnCheckoutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckoutActionPerformed
        int count = tblBillDetails.getRowCount();
    if (count == 0) {
        XNofication.showWarning(this, "Không có món nào để thanh toán.");
        XNofication.showSystemTrayWarning("Thanh toán", "Hóa đơn đang trống.");
        return;
    }

    if (XNofication.confirm(this, "Xác nhận thanh toán hóa đơn này?")) {
        this.checkout();
        XNofication.showSuccess(this, "Thanh toán thành công.");
        XNofication.showSystemTraySuccess("Thanh toán", "Hóa đơn đã được thanh toán.");
    } else {
        XNofication.showMessage(this, "Hủy thao tác thanh toán.", "Thông báo");
    }
    }//GEN-LAST:event_btnCheckoutActionPerformed

    private void btnCancelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelActionPerformed
        if (tblBillDetails.getRowCount() == 0) {
        XNofication.showWarning(this, "Không có món nào để hủy.");
        XNofication.showSystemTrayWarning("Hủy hóa đơn", "Không có món trong hóa đơn.");
        return;
    }

    if (XNofication.confirm(this, "Bạn có chắc muốn hủy toàn bộ hóa đơn không?")) {
        this.cancel();
        XNofication.showSuccess(this, "Hóa đơn đã được hủy.");
        XNofication.showSystemTrayWarning("Hủy hóa đơn", "Đã hủy toàn bộ hóa đơn.");
    } else {
        XNofication.showMessage(this, "Đã hủy thao tác hủy hóa đơn.", "Thông báo");
    }
    }//GEN-LAST:event_btnCancelActionPerformed

    private void tblBillDetailsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblBillDetailsMouseClicked
        if (evt.getClickCount() == 2 && tblBillDetails.getSelectedRow() != -1) {
        this.updateQuantity();
        XNofication.showSystemTraySuccess("Cập nhật số lượng", "Món đã được cập nhật số lượng.");
    }
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        this.open();
        XNofication.showSystemTraySuccess("Khởi động ứng dụng", "PolyCafe đã sẵn sàng.");
    }//GEN-LAST:event_formWindowOpened

    private void formWindowClosed(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosed
        // TODO add your handling code here:
        this.close();
        XNofication.showSystemTrayWarning("Ứng dụng đóng", "PolyCafe đã thoát.");
...
public void setBill(Bill bill) {
    this.bill = bill; // Giả sử bạn có field `Bill bill` trong class
